...
python3.11  /home/iprnb/projects/def-lelis/iprnb/neural-policy-decomposition/agent_recurrent.py --rnn_type "gru" --hidden_size 64 --l1_lambda 0.001 --problem "BL-TR"
