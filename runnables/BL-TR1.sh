...
python3.11  /home/iprnb/projects/def-lelis/iprnb/neural-policy-decomposition/agent_recurrent.py --problem "BL-TR" --seed $SLURM_ARRAY_TASK_ID --episode_length 50 --num_steps 200
