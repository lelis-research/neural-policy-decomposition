...
python3.11  /home/iprnb/projects/def-lelis/iprnb/neural-policy-decomposition/agent_recurrent.py --rnn_type "gru" --hidden_size 16 --l1_lambda 0.00001 --total_timesteps 20000000 --problem "BR-TL"
