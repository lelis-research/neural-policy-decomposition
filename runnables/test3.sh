...
OMP_NUM_THREADS=1 python3.11  /home/iprnb/projects/def-lelis/iprnb/neural-policy-decomposition/agent_recurrent.py --problem "test" --seed $SLURM_ARRAY_TASK_ID --use_options 0
